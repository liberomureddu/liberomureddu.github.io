...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-6 mb-4">
      {% include figure.liquid loading="eager" path="assets/img/libero_gallery/160603_PICTURE_Libero_Toolosoi_Richard_Harris_Original.jpg" title="Landscape 1" caption="Photo by Richard Beresford Harris" class="img-fluid rounded shadow-sm" zoomable=true %}
    </div>
    <div class="col-lg-4 col-md-6 mb-4">
