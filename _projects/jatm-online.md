...
<head>
    ...
    <title>Dynamic Stripe Animation</title>
    <style>
        body {
...
<body>
    <div id="form-container">
        <label for="numStripes">Enter number of stripes (1-20):</label>
        <input type="number" id="numStripes" min="1" max="20" value="7">
    ...
    <script>
        const colors = ["yellow", "orange", "red", "green", "blue", "indigo", "violet"];
        const texts = [
        ...
        function startAnimation() {
            const numStripes = document.getElementById('numStripes').value;
