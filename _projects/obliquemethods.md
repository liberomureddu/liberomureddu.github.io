...
footnotes: true
---
The idea for this software is openly inspired by Peter Schmidt's and Brian Eno's Oblique Strategies.<d-footnote>Peter Schmidt's and Brian Eno's Oblique Strategies <a href="https://www.enoshop.co.uk/product/oblique-strategies?filter=Oblique%20Strategies">[LINK]</a>, is a set of cards 'each of which is a suggestion of a course of action or thinking to assist in creative situations'. The idea of using research methods as the card content was developed during the Summer Academy for Artistic research SAAR 2024 <a href="https://blogit.uniarts.fi/en/post/saar-in-august-2024-in-finland/">[LINK]</a>.</d-footnote>
